...
class Tournament(models.Model):
    ...
    start_date = models.DateField(null=True, blank=True, help_text="Tournament official start date")
    end_date = models.DateField(null=True, blank=True, help_text="Tournament official end date")
    host_country = models.CharField(max_length=200, blank=True, default="", help_text="Host country or host countries")
    organizer = models.CharField(max_length=100, blank=True, default="", help_text="Governing body / organizer (e.g. UEFA, FIFA, EHF)")
    tournament_summary = models.TextField(blank=True, default="", help_text="Summary of tournament edition")
    is_active = models.BooleanField(default=True)
...
class Match(models.Model):
    ...
    venue = models.CharField(max_length=200, blank=True, default="", help_text="Match arena / stadium / city")
